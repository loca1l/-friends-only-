...
local library = {
    ...
    opening = false;
    hasInit = false;
    cheatname = startupArgs.cheatname or 'doa';
    gamename = startupArgs.gamename or 'undefined';
...
function library:CreateSettingsTab(menu)
    ...
    mainSection:AddBind({text = 'Opening Bind', flag = 'togglebind', nomouse = true, noindicator = true, bind = Enum.KeyCode.LeftControl, callback = function()
